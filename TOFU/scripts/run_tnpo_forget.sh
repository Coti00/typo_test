...
forget_mask_path=/home/eastj/tnpo/TOFU/influence_results/influence_masks/spacy_test_forget10_half_forget10/mask_sample_0.18_word_spacy.pt

# Training parameters
batch_size=4  # Reduced from 32 to save GPU memory
gradient_accumulation_steps=1  # Increased to maintain effective batch size of 32
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0,1,2 torchrun \
