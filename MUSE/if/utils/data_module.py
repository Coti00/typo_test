...
class MUSERawTextDataset(Dataset):
    ...
    This dataset reads plain text files where each line is a separate training example.
    It's designed for the MUSE benchmark which uses raw text format instead of Q&A pairs.
    """
    def __init__(self, file_path, tokenizer, max_length=512, answer_only=True):
        ...
        if self.tokenizer.pad_token is None:
            ...
            logging.info(f"Set pad_token to eos_token in MUSERawTextDataset")
